...
pub use self::targets::{
    ...
    CustomVendor, DeploymentTarget, E2kArchitecture, Environment, Mips32Architecture,
    Mips64Architecture, OperatingSystem, Riscv32Architecture, Riscv64Architecture, Vendor,
    X86_32Architecture,
};
